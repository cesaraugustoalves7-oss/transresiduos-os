...
# --- Função para Gerar o PDF Oficial idêntico ao modelo ---
...
if st.button("Gerar OS Oficial e Descarregar 🚀", type="primary"):
    if not descricao_problema.strip() or not solicitante.strip():
        ...
        num_os = datetime.now().strftime('%d%H%M')  # Ex: #00019 adaptado
        ...
        # Botão de Download direto do PDF para enviar por WhatsApp ou E-mail
        st.download_button(
